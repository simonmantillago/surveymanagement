...
import com.surveymanagement.role.application.FindRoleByNameUseCase;  // Added import for FindRoleByIdUseCase
...
public class UpdateRoleUi extends JFrame {
    ...
    private final FindRoleByNameUseCase findRoleByNameUseCase;  // Added findRoleByIdUseCase field
    ...
    public UpdateRoleUi(UpdateRoleUseCase updateRoleUseCase, FindRoleByNameUseCase findRoleByNameUseCase, RoleUiController roleUiController) {
        ...
        this.findRoleByNameUseCase = findRoleByNameUseCase;  // Initialized findRoleByIdUseCase
